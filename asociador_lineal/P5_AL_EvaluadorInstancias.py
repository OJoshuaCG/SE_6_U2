...
import numpy as n
path = "asociador_lineal/"
file_training = "instancia_claseExplicacion_training.txt"
file_test = "instancia_claseExplicacion_test.txt"

archivo = open(path + file_training)
